...
class FollowControllerNode : public rclcpp::Node {
    ...
    target_y_(0.0)
    {
            ...
            target_valid_sub_ = this->create_subscription<std_msgs::msg::Bool>("/mission/follow_enabled", 10, std::bind(&FollowControllerNode::FollowEnabledCallback, this, std__placeholders::_1));
            ...
            odom_sub_ = this->create_subscription<nav_msgs::msg::Odemetry>("/vehicle/odom", 10, std::bind(&FollowControllerNode::OdomCallback, this, std::placeholders::_1));
    ...
    private:
        ...
        void Update() {
            ...
            double cx = std::clamp(KP_VX * target_x_ , -MAX_VX, MAX_VX)
